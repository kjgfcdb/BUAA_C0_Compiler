...
Func_10: # function dowhile
	...
	sw $ra,0($sp) # save $ra
	addu $fp,$sp,4 # fp = new base
	subu $sp,$sp,48 # make space for locals and temps
	li $t0,100 # i=100
	sw $t0,-8($fp)
	li $t0,0 # #reg19=0
	sw $t0,-16($fp)
	lw $t0,-16($fp) # toy=#reg19
	sw $t0,-12($fp)
Label_0:
	lw $t0,-8($fp) # #reg20=i
	sw $t0,-20($fp)
...
exit_Func_10: # exit function dowhile
	addu $sp,$sp,48 # pop locals and temps
	lw $fp,4($sp)
	lw $ra,0($sp)
	addu $sp,$sp,8
	jr $ra
...
Func_12: # function ifcondition
	...
	sw $ra,0($sp) # save $ra
	addu $fp,$sp,4 # fp = new base
	subu $sp,$sp,76 # make space for locals and temps
	li $t0,1 # a=1
	sw $t0,-8($fp)
	li $t0,0 # rightnumber=0
	sw $t0,-12($fp)
	lw $t0,-8($fp) # #reg33=a
	sw $t0,-16($fp)
	li $t0,1 # #reg34=1
...
exit_Func_12: # exit function ifcondition
	addu $sp,$sp,76 # pop locals and temps
	lw $fp,4($sp)
	lw $ra,0($sp)
	addu $sp,$sp,8
	jr $ra
...
Label_27:
	...
	lw $t0,-8($fp) # #reg67=i
	sw $t0,-28($fp)
	lw $t0,-28($fp) # push #reg67
	subu $sp,$sp,4
	sw $t0,0($sp)
	jal Func_13
	addu $v1,$0,$v0 # save the return value
	sw $v1,-32($fp) # #reg68=@RET
	lw $t0,-24($fp)
	lw $t1,-32($fp)
	bne $t0,$t1,Label_28
	lw $t0,-12($fp)
...
Func_17: # function miscellaneous
	...
	sw $ra,0($sp) # save $ra
	addu $fp,$sp,4 # fp = new base
	subu $sp,$sp,1216 # make space for locals and temps
	li $t0,0 # i=0
	sw $t0,-108($fp)
	li $t0,1 # _=1
	sw $t0,-8($fp)
...
Label_47:
	...
	lw $t1,-1184($fp)
	blt $t0,$t1,Label_47
	lw $t0,-108($fp) # endid=i
	sw $t0,-112($fp)
	li $t0,0 # _=0
	sw $t0,-8($fp)
	li $t0,0 # #reg109=0
	sw $t0,-1188($fp)
	lw $t0,-1188($fp) # toy=#reg109
	sw $t0,-116($fp)
Label_48:
	lw $t0,-8($fp)
	li $t1,1
...
exit_Func_17: # exit function miscellaneous
	addu $sp,$sp,1216 # pop locals and temps
	lw $fp,4($sp)
	lw $ra,0($sp)
	addu $sp,$sp,8
	jr $ra
...
Label_64:
	lw $t0,-4($fp) # #reg144=m
	sw $t0,-44($fp)
	lw $t0,-44($fp) # push #reg144
	subu $sp,$sp,4
	sw $t0,0($sp)
	lw $t0,0($fp) # #reg145=n
	sw $t0,-48($fp)
	lw $t0,-48($fp) # push #reg145
	subu $sp,$sp,4
	sw $t0,0($sp)
	lw $t0,-4($fp) # #reg146=m
	sw $t0,-52($fp)
	lw $t0,-52($fp) # push #reg146
	subu $sp,$sp,4
	sw $t0,0($sp)
	jal Func_21
	addu $v1,$0,$v0 # save the return value
	sw $v1,-56($fp) # #reg147=@RET
	lw $t0,-56($fp) # push #reg147
	subu $sp,$sp,4
	sw $t0,0($sp)
	jal Func_22
	addu $v1,$0,$v0 # save the return value
	sw $v1,-60($fp) # #reg148=@RET
	lw $v0,-60($fp)
	j exit_Func_22
...
Func_25: # function is_prime
	...
	sw $ra,0($sp) # save $ra
	addu $fp,$sp,8 # fp = new base
	subu $sp,$sp,56 # make space for locals and temps
	li $t0,2 # i=2
	sw $t0,-12($fp)
	lw $t0,0($fp) # #reg167=x
	sw $t0,-20($fp)
...
Label_73:
	li $t0,0 # #reg170=0
	sw $t0,-32($fp)
	lw $t0,-32($fp) # toy=#reg170
	sw $t0,-16($fp)
Label_74:
	lw $t0,0($fp) # #reg171=x
	sw $t0,-36($fp)
	lw $t0,-36($fp) # push #reg171
	subu $sp,$sp,4
	sw $t0,0($sp)
	lw $t0,-12($fp) # #reg172=i
	sw $t0,-40($fp)
	lw $t0,-40($fp) # push #reg172
	subu $sp,$sp,4
	sw $t0,0($sp)
	jal Func_21
	addu $v1,$0,$v0 # save the return value
	sw $v1,-44($fp) # #reg173=@RET
	li $t0,0 # #reg174=0
	sw $t0,-48($fp)
	lw $t0,-44($fp)
	lw $t1,-48($fp)
...
exit_Func_25: # exit function is_prime
	addu $sp,$sp,56 # pop locals and temps
	lw $fp,4($sp)
	lw $ra,0($sp)
	addu $sp,$sp,12
	jr $ra
...
Label_78:
	li $t0,0 # #reg184=0
	sw $t0,-36($fp)
	lw $t0,-36($fp) # fuck=#reg184
	sw $t0,-24($fp)
Label_79:
	lw $t0,-12($fp) # #reg185=i
	sw $t0,-40($fp)
	lw $t0,-40($fp) # push #reg185
	subu $sp,$sp,4
	sw $t0,0($sp)
	jal Func_25
	addu $v1,$0,$v0 # save the return value
	sw $v1,-44($fp) # #reg186=@RET
	li $t0,1 # #reg187=1
	sw $t0,-48($fp)
	lw $t0,-44($fp)
	lw $t1,-48($fp)
	...
	lw $t0,0($fp) # #reg188=n
	sw $t0,-52($fp)
	lw $t0,-52($fp) # push #reg188
	subu $sp,$sp,4
	sw $t0,0($sp)
	lw $t0,-12($fp) # #reg189=i
	sw $t0,-56($fp)
	lw $t0,-56($fp) # push #reg189
	subu $sp,$sp,4
	sw $t0,0($sp)
	jal Func_21
	addu $v1,$0,$v0 # save the return value
	sw $v1,-60($fp) # #reg190=@RET
	li $t0,0 # #reg191=0
	sw $t0,-64($fp)
	lw $t0,-60($fp)
	lw $t1,-64($fp)
...
Label_84:
	...
	lw $t0,0($fp) # #reg198=n
	sw $t0,-84($fp)
	lw $t0,-84($fp) # push #reg198
	subu $sp,$sp,4
	sw $t0,0($sp)
	lw $t0,-12($fp) # #reg199=i
	sw $t0,-88($fp)
	lw $t0,-88($fp) # push #reg199
	subu $sp,$sp,4
	sw $t0,0($sp)
	jal Func_21
	addu $v1,$0,$v0 # save the return value
	sw $v1,-92($fp) # #reg200=@RET
	li $t0,0 # #reg201=0
	sw $t0,-96($fp)
	lw $t0,-92($fp)
	lw $t1,-96($fp)
